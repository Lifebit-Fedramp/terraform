variable "create" {
  description = "Determines whether service resources will be created"
  type        = bool
  default     = true
}
...
variable "app_port" {
  description = "App port for target group to listen on"
  type        = number
  default     = 80
}

variable "tg_protocol" {
  description = "Protocol for the service target group"
  type        = string
  default     = "HTTP"
}

variable "target_type" {
  description = "Target type for the service target group"
  type        = string
  default     = "ip"
}

variable "health_check_path" {
  description = "Health check path for the service target group"
  type        = string
  default     = "/"
}

variable "listener_arn" {
  description = "Listener ARN to add service listener rule to"
  type        = string
  default     = ""
}

variable "rule_priority" {
  description = "Priority for service listener rule"
  type        = number
  default     = 100
}

variable "path_pattern" {
  description = "Path pattern to match on for service listener rule"
  type        = list(string)
  default     = ["/*"]
}
