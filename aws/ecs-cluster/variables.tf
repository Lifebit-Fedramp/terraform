...
variable "instances_user_data_tpl_path" {
  description = "User Data template file path for connecting instance to ECS (refer to instances_user_data_tpl)"
  type        = string
  default     = "generic_user_data.tftpl"
}

variable "ingress_source_sgs" {
