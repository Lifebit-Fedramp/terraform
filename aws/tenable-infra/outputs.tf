...
output "key_pair_id" {
  ...
  value       = try(module.key_pair.key_pair_id, "")
}

output "key_pair_arn" {
  description = "The key pair ARN"
  value       = try(module.key_pair.arn, "")
}

output "key_pair_name" {
  description = "The key pair name"
  value       = try(module.key_pair.key_name, "")
}

output "key_pair_fingerprint" {
  description = "The MD5 public key fingerprint as specified in section 4 of RFC 4716"
  value       = try(module.key_pair.fingerprint, "")
}
...
output "public_key_fingerprint_md5" {
  ...
  value       = try(module.key_pair.public_key_fingerprint_md5, "")
}
...
output "public_key_fingerprint_sha256" {
  ...
  value       = try(module.key_pair.public_key_fingerprint_sha256, "")
}
